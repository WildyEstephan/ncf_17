...

{
    ...
    "depends": ["l10n_do", "hr_payroll","hr_payroll_account", "contacts", "hr_attendance", 'hr_holidays', "sh_message", "hr_work_entry_contract", "hr"],
    "license": "GPL-3",
    "version": "17.0.0.0.1",
    "description": """
...
=================================
    ...
    "data": [
        ...
        'data/l10n_do_hr_payroll_rates.xml',
        # Sequence
        "data/sequence.xml",
