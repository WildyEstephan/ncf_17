...
class PayrollStructure(models.Model):
    ...
    def fill_rule_structure(self):
        ...
        struct_f_id = self.env.ref('l10n_do_hr_payroll.hr_payroll_structure_base').id
        struct_c_id = self.env.ref('l10n_do_hr_payroll.christmas_salary_structure').id
        struct_ex_id = self.env.ref('l10n_do_hr_payroll.structure_foreign_employees').id
        struct_s_id = self.env.ref('l10n_do_hr_payroll.hr_payroll_structure_out').id
        ...
        out_rules = self.env['hr.salary.rule'].search([('struct_id', '=', struct_s_id)])
        ...
        elif out_rules and not self.country_id and self.schedule_pay == 'bi-weekly':
